...
export const AdminAPI = (client: BaseSlackAPIClient) => {
  ...
  admin.apps.approve = async (
    ...
    return await client.call("admin.apps.approve", args);
  };
  admin.apps.approved = {};
  ...
  admin.apps.approved.list = async (
    ...
    return await client.call("admin.apps.approved.list", args);
  };
  admin.apps.requests = {};
  ...
  admin.apps.requests.list = async (
    ...
    return await client.call("admin.apps.requests.list", args);
  };

  admin.apps.restrict = async (
    args: SlackAPIMethodArgs,
  ): Promise<BaseResponse> => {
    return await client.call("admin.apps.restrict", args);
  };
  ...
  admin.apps.restricted.list = async (
    ...
    return await client.call("admin.apps.restricted.list", args);
  };
  admin.conversations = {};
  ...
  admin.conversations.archive = async (
    ...
    return await client.call("admin.conversations.archive", args);
  };

  admin.conversations.convertToPrivate = async (
    args: SlackAPIMethodArgs,
  ): Promise<BaseResponse> => {
    return await client.call("admin.conversations.convertToPrivate", args);
  };

  admin.conversations.create = async (
    args: SlackAPIMethodArgs,
  ): Promise<BaseResponse> => {
    return await client.call("admin.conversations.create", args);
  };

  admin.conversations.delete = async (
    args: SlackAPIMethodArgs,
  ): Promise<BaseResponse> => {
    return await client.call("admin.conversations.delete", args);
  };

  admin.conversations.disconnectShared = async (
    args: SlackAPIMethodArgs,
  ): Promise<BaseResponse> => {
    return await client.call("admin.conversations.disconnectShared", args);
  };
  ...
  admin.conversations.getConversationPrefs = async (
    ...
    return await client.call("admin.conversations.getConversationPrefs", args);
  };

  admin.conversations.getTeams = async (
    args: SlackAPIMethodArgs,
  ): Promise<BaseResponse> => {
    return await client.call("admin.conversations.getTeams", args);
  };

  admin.conversations.invite = async (
    args: SlackAPIMethodArgs,
  ): Promise<BaseResponse> => {
    return await client.call("admin.conversations.invite", args);
  };

  admin.conversations.rename = async (
    args: SlackAPIMethodArgs,
  ): Promise<BaseResponse> => {
    return await client.call("admin.conversations.rename", args);
  };
  ...
  admin.conversations.search = async (
    ...
    return await client.call("admin.conversations.search", args);
  };

  admin.conversations.setConversationPrefs = async (
    args: SlackAPIMethodArgs,
  ): Promise<BaseResponse> => {
    return await client.call("admin.conversations.setConversationPrefs", args);
  };

  admin.conversations.setTeams = async (
    args: SlackAPIMethodArgs,
  ): Promise<BaseResponse> => {
    return await client.call("admin.conversations.setTeams", args);
  };

  admin.conversations.unarchive = async (
    args: SlackAPIMethodArgs,
  ): Promise<BaseResponse> => {
    return await client.call("admin.conversations.unarchive", args);
  };
  admin.emoji = {};

  admin.emoji.add = async (args: SlackAPIMethodArgs): Promise<BaseResponse> => {
    return await client.call("admin.emoji.add", args);
  };

  admin.emoji.addAlias = async (
    args: SlackAPIMethodArgs,
  ): Promise<BaseResponse> => {
    return await client.call("admin.emoji.addAlias", args);
  };

  admin.emoji.list = async (
    args: SlackAPIMethodArgs,
  ): Promise<BaseResponse> => {
    return await client.call("admin.emoji.list", args);
  };

  admin.emoji.remove = async (
    args: SlackAPIMethodArgs,
  ): Promise<BaseResponse> => {
    return await client.call("admin.emoji.remove", args);
  };

  admin.emoji.rename = async (
    args: SlackAPIMethodArgs,
  ): Promise<BaseResponse> => {
    return await client.call("admin.emoji.rename", args);
  };
  ...
  admin.inviteRequests.approve = async (
    ...
    return await client.call("admin.inviteRequests.approve", args);
  };
  ...
  admin.inviteRequests.approved.list = async (
    ...
    return await client.call("admin.inviteRequests.approved.list", args);
  };
  ...
  admin.inviteRequests.denied.list = async (
    ...
    return await client.call("admin.inviteRequests.denied.list", args);
  };

  admin.inviteRequests.deny = async (
    args: SlackAPIMethodArgs,
  ): Promise<BaseResponse> => {
    return await client.call("admin.inviteRequests.deny", args);
  };

  admin.inviteRequests.list = async (
    args: SlackAPIMethodArgs,
  ): Promise<BaseResponse> => {
    return await client.call("admin.inviteRequests.list", args);
  };
  admin.teams = {};
  admin.teams.admins = {};
  ...
  admin.teams.admins.list = async (
    ...
    return await client.call("admin.teams.admins.list", args);
  };

  admin.teams.create = async (
    args: SlackAPIMethodArgs,
  ): Promise<BaseResponse> => {
    return await client.call("admin.teams.create", args);
  };

  admin.teams.list = async (
    args: SlackAPIMethodArgs,
  ): Promise<BaseResponse> => {
    return await client.call("admin.teams.list", args);
  };
  admin.teams.owners = {};
  ...
  admin.teams.owners.list = async (
    ...
    return await client.call("admin.teams.owners.list", args);
  };
  ...
  admin.teams.settings.info = async (
    ...
    return await client.call("admin.teams.settings.info", args);
  };

  admin.teams.settings.setDefaultChannels = async (
    args: SlackAPIMethodArgs,
  ): Promise<BaseResponse> => {
    return await client.call("admin.teams.settings.setDefaultChannels", args);
  };

  admin.teams.settings.setDescription = async (
    args: SlackAPIMethodArgs,
  ): Promise<BaseResponse> => {
    return await client.call("admin.teams.settings.setDescription", args);
  };

  admin.teams.settings.setDiscoverability = async (
    args: SlackAPIMethodArgs,
  ): Promise<BaseResponse> => {
    return await client.call("admin.teams.settings.setDiscoverability", args);
  };

  admin.teams.settings.setIcon = async (
    args: SlackAPIMethodArgs,
  ): Promise<BaseResponse> => {
    return await client.call("admin.teams.settings.setIcon", args);
  };

  admin.teams.settings.setName = async (
    args: SlackAPIMethodArgs,
  ): Promise<BaseResponse> => {
    return await client.call("admin.teams.settings.setName", args);
  };
  admin.usergroups = {};
  ...
  admin.usergroups.addChannels = async (
    ...
    return await client.call("admin.usergroups.addChannels", args);
  };

  admin.usergroups.addTeams = async (
    args: SlackAPIMethodArgs,
  ): Promise<BaseResponse> => {
    return await client.call("admin.usergroups.addTeams", args);
  };

  admin.usergroups.listChannels = async (
    args: SlackAPIMethodArgs,
  ): Promise<BaseResponse> => {
    return await client.call("admin.usergroups.listChannels", args);
  };

  admin.usergroups.removeChannels = async (
    args: SlackAPIMethodArgs,
  ): Promise<BaseResponse> => {
    return await client.call("admin.usergroups.removeChannels", args);
  };
  admin.users = {};
  ...
  admin.users.assign = async (
    ...
    return await client.call("admin.users.assign", args);
  };

  admin.users.invite = async (
    args: SlackAPIMethodArgs,
  ): Promise<BaseResponse> => {
    return await client.call("admin.users.invite", args);
  };

  admin.users.list = async (
    args: SlackAPIMethodArgs,
  ): Promise<BaseResponse> => {
    return await client.call("admin.users.list", args);
  };

  admin.users.remove = async (
    args: SlackAPIMethodArgs,
  ): Promise<BaseResponse> => {
    return await client.call("admin.users.remove", args);
  };
  admin.users.session = {};
  ...
  admin.users.session.invalidate = async (
    ...
    return await client.call("admin.users.session.invalidate", args);
  };

  admin.users.session.reset = async (
    args: SlackAPIMethodArgs,
  ): Promise<BaseResponse> => {
    return await client.call("admin.users.session.reset", args);
  };

  admin.users.setAdmin = async (
    args: SlackAPIMethodArgs,
  ): Promise<BaseResponse> => {
    return await client.call("admin.users.setAdmin", args);
  };

  admin.users.setExpiration = async (
    args: SlackAPIMethodArgs,
  ): Promise<BaseResponse> => {
    return await client.call("admin.users.setExpiration", args);
  };

  admin.users.setOwner = async (
    args: SlackAPIMethodArgs,
  ): Promise<BaseResponse> => {
    return await client.call("admin.users.setOwner", args);
  };

  admin.users.setRegular = async (
    args: SlackAPIMethodArgs,
  ): Promise<BaseResponse> => {
    return await client.call("admin.users.setRegular", args);
  };
