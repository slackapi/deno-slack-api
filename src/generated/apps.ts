...
export const AppsAPI = (client: BaseSlackAPIClient) => {
  ...
  apps.event.authorizations.list = async (
    ...
    return await client.call("apps.event.authorizations.list", args);
  };
  apps.permissions = {};
  ...
  apps.permissions.info = async (
    ...
    return await client.call("apps.permissions.info", args);
  };

  apps.permissions.request = async (
    args: SlackAPIMethodArgs,
  ): Promise<BaseResponse> => {
    return await client.call("apps.permissions.request", args);
  };
  ...
  apps.permissions.resources.list = async (
    ...
    return await client.call("apps.permissions.resources.list", args);
  };
  ...
  apps.permissions.scopes.list = async (
    ...
    return await client.call("apps.permissions.scopes.list", args);
  };

  apps.uninstall = async (args: SlackAPIMethodArgs): Promise<BaseResponse> => {
    return await client.call("apps.uninstall", args);
  };
